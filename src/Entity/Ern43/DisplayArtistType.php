...
class DisplayArtistType
{
     ...
     *
     * @var \DedexBundle\Entity\Ern43\DisplayArtistRoleType $displayArtistRole
     */
     ...
     *
     * @var \DedexBundle\Entity\Ern43\ContributorRoleType[] $artisticRole
     */
     ...
     *
     * @var \DedexBundle\Entity\Ern43\TitleDisplayInformationType[] $titleDisplayInformation
     */
     ...
     * A Composite containing details of a Role played by the DisplayArtist.
     *
     * @param \DedexBundle\Entity\Ern43\DisplayArtistRoleType $displayArtistRole
     * @return self
     */
    public function setDisplayArtistRole(\DedexBundle\Entity\Ern43\DisplayArtistRoleType $displayArtistRole)
    {
     ...
     */
    public function addToArtisticRole(\DedexBundle\Entity\Ern43\ContributorRoleType $artisticRole)
    {
     ...
     */
    public function addToTitleDisplayInformation(\DedexBundle\Entity\Ern43\TitleDisplayInformationType $titleDisplayInformation)
    {
     ...
     * A Composite containing information on how a RecordCompany wishes Artist information to be presented to Consumers as part of the Title (and in addition to displaying the DisplayArtist information).
     *
     * @return \DedexBundle\Entity\Ern43\TitleDisplayInformationType[]
     */
