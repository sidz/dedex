...
class TitleDisplayInformationType
{
     ...
     *
     * @var \DedexBundle\Entity\Ern43\PrefixType[] $prefix
     */
    private $prefix = [
     ...
     */
    public function addToPrefix(\DedexBundle\Entity\Ern43\PrefixType $prefix)
    {
        $this->prefix[] = $prefix;
        return $this;
    }
     ...
     * A Descriptor that precedes the display artist name when multiple display artist names are given.
     *
     * @return \DedexBundle\Entity\Ern43\PrefixType[]
     */
