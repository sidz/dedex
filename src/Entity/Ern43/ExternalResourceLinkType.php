...
class ExternalResourceLinkType
{
     ...
     *
     * @var \DedexBundle\Entity\Ern43\ExternallyLinkedResourceTypeType[] $externallyLinkedResourceType
     */
     ...
     */
    public function addToExternallyLinkedResourceType(\DedexBundle\Entity\Ern43\ExternallyLinkedResourceTypeType $externallyLinkedResourceType)
    {
     ...
     * A Composite containing details of the Type of a Resource pointed to by the ExternalResourceLink.
     *
     * @return \DedexBundle\Entity\Ern43\ExternallyLinkedResourceTypeType[]
     */
