...
class ResourceListType
{
     ...
     *
     * @var \DedexBundle\Entity\Ern43\SoundRecordingType[] $soundRecording
     */
     ...
     *
     * @var \DedexBundle\Entity\Ern43\VideoType[] $video
     */
    private $video = [
     ...
     *
     * @var \DedexBundle\Entity\Ern43\ImageType[] $image
     */
    private $image = [
     ...
     *
     * @var \DedexBundle\Entity\Ern43\TextType[] $text
     */
    private $text = [
     ...
     *
     * @var \DedexBundle\Entity\Ern43\SheetMusicType[] $sheetMusic
     */
    private $sheetMusic = [
     ...
     *
     * @var \DedexBundle\Entity\Ern43\SoftwareType[] $software
     */
    private $software = [
     ...
     */
    public function addToSoundRecording(\DedexBundle\Entity\Ern43\SoundRecordingType $soundRecording)
    {
     ...
     * A Composite containing details of a SoundRecording.
     *
     * @return \DedexBundle\Entity\Ern43\SoundRecordingType[]
     */
     ...
     */
    public function addToVideo(\DedexBundle\Entity\Ern43\VideoType $video)
    {
        $this->video[] = $video;
        return $this;
    }
     ...
     * A Composite containing details of a Video.
     *
     * @return \DedexBundle\Entity\Ern43\VideoType[]
     */
     ...
     */
    public function addToImage(\DedexBundle\Entity\Ern43\ImageType $image)
    {
        $this->image[] = $image;
        return $this;
    }
     ...
     * A Composite containing details of an Image.
     *
     * @return \DedexBundle\Entity\Ern43\ImageType[]
     */
     ...
     */
    public function addToText(\DedexBundle\Entity\Ern43\TextType $text)
    {
        $this->text[] = $text;
        return $this;
    }
     ...
     * A Composite containing details of a Text.
     *
     * @return \DedexBundle\Entity\Ern43\TextType[]
     */
     ...
     */
    public function addToSheetMusic(\DedexBundle\Entity\Ern43\SheetMusicType $sheetMusic)
    {
     ...
     * A Composite containing details of a SheetMusic.
     *
     * @return \DedexBundle\Entity\Ern43\SheetMusicType[]
     */
     ...
     */
    public function addToSoftware(\DedexBundle\Entity\Ern43\SoftwareType $software)
    {
     ...
     * A Composite containing details of an item of Software.
     *
     * @return \DedexBundle\Entity\Ern43\SoftwareType[]
     */
